...
// "/storage/emulated/0/" + app.GetAppName();
var curMenu = "Home";
var curPage = null;
...
function CreateDrawer()
{
	...
	var img = app.CreateImage( "Img/Taladrandole bien duro su sabroso culote a la colora.png", 0.25 );
	...
	txtTitle = app.CreateText( "Videos:",-1,-1,"Left");
